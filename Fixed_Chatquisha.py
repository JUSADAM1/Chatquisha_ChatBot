...
class Window:
    ...
    def __init__(self):
        ...
        self.tab_control.add(self.tab5, text='Face Detection')
        ...
        label5 = Label(self.tab5, text='FACIAL RECOGNITION!!!!!!', padx=55, pady=55, font='Times 32')
        ...
        self.button_process_stuff4 = Button(self.tab5, text= "Face Detect", command= self.run_facial_rec, width=40, bg="#ff9900", fg="#000000")
        self.button_process_stuff4.grid(row =5, column=0, padx=10, pady = 10)
        self.convo_started = False

    #For running the loop for everything
    def run(self):
        self.window.mainloop()
    #For ending the convosation
    def end_convo(self):
